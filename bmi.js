function calbmi(){
   ...
   if (120> h && h >3) {
    ...
    if (g==1 && a==2){
        ...
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(16.6*hm*hm).toFixed(2);
    ...
    if (g==1 && a==3){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(16.0*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==4){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(15.6*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==5){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(15.4*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==7){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(15.5*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==8){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(15.8*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==9){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(16.2*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==11){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(17.2*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==12){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(17.8*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==13){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(18.4*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==1 && a==14){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(19.1*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==2){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(16.4*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==3){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(15.7*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==5){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(15.2*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==6){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(15.3*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==10){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(16.8*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==11){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(17.5*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==12){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(18.1*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==13){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(18.7*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
    ...
    if (g==2 && a==14){
        document.getElementById("target").style.display = "block";
        document.getElementById("target").innerHTML = "Target body weight is "+parseFloat(19.3*hm*hm).toFixed(2);
        document.getElementById("cmessage").style.display = "block";
        document.getElementById("bmimsg").style.display = "block";
        document.getElementById("bmimsg").innerHTML = "BMI Value is "+bmix;
